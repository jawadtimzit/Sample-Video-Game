...
public class VideoGame1 extends JFrame implements KeyListener, ActionListener  {   
    ...
    private int totalNumberOfShapes = 4;
    private static Shape [] shapeList; 
    private int collisionDistance = 20; 
    ...
    public VideoGame1()
    {
        ...
        //Diamond s1 = new Diamond(randX(),randY(),50, Color.RED);
        //Diamond s2 = new Diamond(randX(),randY(),50, Color.GREEN);
       // Diamond s3 = new Diamond(randX(),randY(),50, Color.ORANGE);
        Triangle s3=new Triangle(randX(),randY(),70, Color.ORANGE);
        Diamond s4 = new Diamond(randX(),randY(),70, 50,Color.MAGENTA);
        Circle s1 = new Circle(randX(),randY(),70, Color.RED);
        Pacman s2 = new Pacman(randX(),randY(),70, Color.GREEN,30,310);
    ...
    {
        System.out.println("----------- Trianlge Test ------------------");
        Triangle t=(Triangle)shapeList[2];//new Triangle(12,45,70,Color.GREEN);
        System.out.println("TESTING AREA {EXPECT : 2450} :"+t.getArea());
        System.out.println("TESTING Width {EXPECT : 70} :"+t.getTraingle_Width());
        System.out.println("----------- Diamond Test ------------------");
        Diamond d=(Diamond)shapeList[3];//new Diamond(12,45,70,50,Color.GREEN);
        System.out.println("TESTING AREA {EXPECT : 3500} :"+d.getArea());
        System.out.println("TESTING Width {EXPECT : 70} :"+d.getWidth());
        System.out.println("TESTING Width {EXPECT : 50} :"+d.getWidth());
        System.out.println("----------- Circle Test ------------------");
        Circle c=(Circle)shapeList[0];//new Circle(12,45,70,Color.GREEN);
        System.out.println("TESTING AREA {EXPECT : ~15386} :"+c.getArea());
        System.out.println("TESTING Radius {EXPECT : 70} :"+c.getRadius());
        System.out.println("----------- Pacman Test ------------------");
        Pacman cp=(Pacman)shapeList[1];//new Pacman(12,45,70,Color.GREEN,12,145);
        System.out.println("TESTING AREA {EXPECT : if angle < 180: ~7696 else: ~15393} :"+cp.getArea());
        System.out.println("TESTING Radius {EXPECT : 70} :"+cp.getRadius());
        System.out.println("TESTING Start Angle(ARC) {EXPECT : 30} :"+cp.getArcStartAngle());
        System.out.println("TESTING END Angle {EXPECT : 310} :"+cp.getArcEndAngle());
    }
